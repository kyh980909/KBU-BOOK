...
<div class="container">
    <form class="form-signin" method="post" name="Login" action="Login/loginProc.jsp">
        ...
        <p align="center">
            ...
            <a href='Login/s_id.jsp' onclick="window.open(this.href,'ID찾기','toolbar=no, ' +
               'location=center, status=no, resizable=no, width=800,' +
                ' height=200'); return false;">아이디&비밀번호 찾기
            </a>
        </p>
        <br>
    </form>
