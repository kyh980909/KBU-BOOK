...
<div align="center">
    ...
    <form name="check" method="post" action="id_check.jsp">
        <input type="text" size="50" value="" placeholder="중복확인 해주셈." name="id" class="text-form" id="uid" required>
        <input type="submit" value="중복확인" onclick="checkid(this.check)" class="btn btn-warning">
    </form>
    <% } else {
