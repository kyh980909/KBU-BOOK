...
<style>
    ...
    body {
        background-color: rgba(243, 170, 127, 0.53);
    }
</style>
...
<form method="post" name="email_check">
    <div align="center">
        ...
        <hr></hr>
        <p><input type="text" name="emailbox" placeholder="인증번호를 입력하십시오!" class="text-form" size="10" maxlength="6">
            <input type="button" value="인증" onclick="check_e(this.form, <%=Num%>)" class="btn btn-success"></p>
